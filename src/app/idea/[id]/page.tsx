...
export default function IdeaDetail() {
  ...
  const idea = mockIdeas.find((q) => q.id === ideaId);
        ...
        <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50">
          ...
          <main className="pt-16">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
              <div className="bg-white rounded-2xl shadow-xl border border-amber-200 p-8 md:p-12 text-center">
                <h1 className="text-2xl font-bold text-amber-900 mb-4">Idea Not Found</h1>
                <p className="text-amber-700 mb-6">The idea you're looking for doesn't exist.</p>
                <button
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="bg-white rounded-2xl shadow-xl border border-amber-200 p-8 md:p-12">
              ...
              <div className="mb-8">
                <button
                  onClick={() => router.push('/dashboard')}
                  className="text-amber-600 hover:text-amber-900 mb-4 flex items-center gap-2 transition-colors"
                >
                  <svg
                    className="w-5 h-5"
                    fill="none"
              ...
              {/* Actions */}
              <div className="mt-8 pt-6 border-t border-amber-200 flex gap-3">
                <button
